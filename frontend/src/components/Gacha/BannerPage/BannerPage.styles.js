 ...
 *
 * Consolidated styles for the Banner page components.
 * Extracted from BannerPage.js for better maintainability.
 */

import styled from 'styled-components';
import { motion } from 'framer-motion';
import { theme, PageWrapper, Section, Chip, scrollbarStyles } from '../../../design-system';
