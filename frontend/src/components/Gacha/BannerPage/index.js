 ...
 *
 * Decomposed components for the BannerPage to improve maintainability.
 * Each component handles a specific section of the banner page.
 */

export { default as BannerHeroSection } from './BannerHeroSection';
